<%@ Page Language="C#" AutoEventWireup="True" CodeFile="Material.SUITestPage.aspx.cs" Inherits="Material_SUI_TestPage" %>
    ...
    <form id="form1" runat="server" style="height: 100%">
        <div id="silverlightControlHost">
            <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%" style="float: left;">
                <param name="source" value="ClientBin/Material.SUI.xap" />
