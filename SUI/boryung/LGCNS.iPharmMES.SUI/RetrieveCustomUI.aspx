<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RetrieveCustomUI.aspx.cs" Inherits="RetrieveCustomUI" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>RetrieveCustomUI</title>
    <style type="text/css">
    html, body {
	    height: 100%;
	    overflow: auto;
    ...
    <script type="text/javascript">
        ...
        <script type="text/javascript">
            function scriptFunctionSelectionChanged(val) {
                try
                {                   
                    document.getElementById("SelectedCustom").value = val;
                }
                catch(e)
                {
                }
...
<body>
    <form id="form1" runat="server" style="height:100%; width:100%">        
        <input type="hidden" id="SelectedCustom" name="SelectedCustom" value="<%=SelectedCustom%>" runat="server"/>

        <div id="silverlightControlHost">
            
            <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%">
		      <param name="source" value="ClientBin/RetrieveCustomUI.xap"/>
