...
namespace 보령
{
    public class 비정량적시험ViewModel : ViewModelBase
    {
        #region Property
        public 비정량적시험ViewModel()
        {
        ...
        private 비정량적시험 _mainWnd;
        private string IPC_TSID = "비정량적시험";
        ...
        private IPCControlData _AppearanceIPCData;
        public IPCControlData AppearanceIPCData
        {
            get { return _AppearanceIPCData; }
            set
            {
                _AppearanceIPCData = value;
                OnPropertyChanged("AppearanceIPCData");
            }
        }

        private IPCControlData _UnitIPCData;
        public IPCControlData UnitIPCData
        {
            get { return _UnitIPCData; }
            set
            {
                _UnitIPCData = value;
                OnPropertyChanged("UnitIPCData");
            }
        }

        private IPCControlData _BatchIPCData;
        public IPCControlData BatchIPCData
        {
            get { return _BatchIPCData; }
            set
            {
                _BatchIPCData = value;
                OnPropertyChanged("BatchIPCData");
            }
        }

        private IPCControlData _ExpiryIPCData;
        public IPCControlData ExpiryIPCData
        {
            get { return _ExpiryIPCData; }
            set
            {
                _ExpiryIPCData = value;
                OnPropertyChanged("ExpiryIPCData");
            }
        }

        private IPCControlData _ConfirmIPCData;
        public IPCControlData ConfirmIPCData
        {
            get { return _ConfirmIPCData; }
            set
            {
                _ConfirmIPCData = value;
                OnPropertyChanged("ConfirmIPCData");
            }
        }

        private IPCControlData _ConfidentIPCData;
        public IPCControlData ConfidentIPCData
        {
            get { return _ConfidentIPCData; }
            set
            {
                _ConfidentIPCData = value;
                OnPropertyChanged("ConfidentIPCData");
            }
        }
                ...
                return new AsyncCommandBase(async arg =>
                {
                    using (await AwaitableLocks["LoadedCommandAsync"].EnterAsync())
                    {
                        try
                        {
                            ...
                            ///
                            if(arg != null && arg is 비정량적시험)
                            {
                                _mainWnd = arg as 비정량적시험;
                                ...
                                if(await _BR_BRS_SEL_ProductionOrderIPCStandard.Execute() && _BR_BRS_SEL_ProductionOrderIPCStandard.OUTDATAs.Count == 7)
                                {
                                    ShapeIPCData = IPCControlData.SetIPCControlData(_BR_BRS_SEL_ProductionOrderIPCStandard.OUTDATAs[0]);
                                    AppearanceIPCData = IPCControlData.SetIPCControlData(_BR_BRS_SEL_ProductionOrderIPCStandard.OUTDATAs[1]);
                                    UnitIPCData = IPCControlData.SetIPCControlData(_BR_BRS_SEL_ProductionOrderIPCStandard.OUTDATAs[2]);
                                    BatchIPCData = IPCControlData.SetIPCControlData(_BR_BRS_SEL_ProductionOrderIPCStandard.OUTDATAs[3]);
                                    ExpiryIPCData = IPCControlData.SetIPCControlData(_BR_BRS_SEL_ProductionOrderIPCStandard.OUTDATAs[4]);
                                    ConfirmIPCData = IPCControlData.SetIPCControlData(_BR_BRS_SEL_ProductionOrderIPCStandard.OUTDATAs[5]);
                                    ConfidentIPCData = IPCControlData.SetIPCControlData(_BR_BRS_SEL_ProductionOrderIPCStandard.OUTDATAs[6]);
                ...
                return new AsyncCommandBase(async arg =>
                {
                    using (await AwaitableLocks["RegisterIPCCommandAsync"].EnterAsync())
                    {
                        try
                        {
                            ...
                            ///
                            if (_ShapeIPCData.DEVIATIONFLAG.HasValue)
                            {
                                ...
                                {
                                    POTSRGUID = _BR_BRS_REG_ProductionOrderTestResult.INDATA_SPECs[0].POTSRGUID,
                                    OPTSIGUID = new Guid(_AppearanceIPCData.OPTSIGUID),
                                    POTSIRGUID = Guid.NewGuid(),
                                    ACTVAL = _AppearanceIPCData.GetACTVAL.ToString(),
                                    INSUSER = user,
                                    INSDTTM = curDttm,
                                    EFCTTIMEIN = curDttm,
                                    EFCTTIMEOUT = curDttm,
                                ...
                                {
                                    POTSRGUID = _BR_BRS_REG_ProductionOrderTestResult.INDATA_SPECs[0].POTSRGUID,
                                    OPTSIGUID = new Guid(_UnitIPCData.OPTSIGUID),
                                    POTSIRGUID = Guid.NewGuid(),
                                    ACTVAL = _UnitIPCData.GetACTVAL.ToString(),
                                    INSUSER = user,
                                    INSDTTM = curDttm,
                                    EFCTTIMEIN = curDttm,
                                    EFCTTIMEOUT = curDttm,
                                ...
                                {
                                    POTSRGUID = _BR_BRS_REG_ProductionOrderTestResult.INDATA_SPECs[0].POTSRGUID,
                                    OPTSIGUID = new Guid(_BatchIPCData.OPTSIGUID),
                                    POTSIRGUID = Guid.NewGuid(),
                                    ACTVAL = _BatchIPCData.GetACTVAL.ToString(),
                                    INSUSER = user,
                                    INSDTTM = curDttm,
                                    EFCTTIMEIN = curDttm,
                                    EFCTTIMEOUT = curDttm,
                                ...
                                {
                                    POTSRGUID = _BR_BRS_REG_ProductionOrderTestResult.INDATA_SPECs[0].POTSRGUID,
                                    OPTSIGUID = new Guid(_ExpiryIPCData.OPTSIGUID),
                                    POTSIRGUID = Guid.NewGuid(),
                                    ACTVAL = _ExpiryIPCData.GetACTVAL.ToString(),
                                    INSUSER = user,
                                    INSDTTM = curDttm,
                                    EFCTTIMEIN = curDttm,
                                    EFCTTIMEOUT = curDttm,
                                ...
                                {
                                    POTSRGUID = _BR_BRS_REG_ProductionOrderTestResult.INDATA_SPECs[0].POTSRGUID,
                                    OPTSIGUID = new Guid(_ConfirmIPCData.OPTSIGUID),
                                    POTSIRGUID = Guid.NewGuid(),
                                    ACTVAL = _ConfirmIPCData.GetACTVAL.ToString(),
                                    INSUSER = user,
                                    INSDTTM = curDttm,
                                    EFCTTIMEIN = curDttm,
                                    EFCTTIMEOUT = curDttm,
                                ...
                                {
                                    POTSRGUID = _BR_BRS_REG_ProductionOrderTestResult.INDATA_SPECs[0].POTSRGUID,
                                    OPTSIGUID = new Guid(_ConfidentIPCData.OPTSIGUID),
                                    POTSIRGUID = Guid.NewGuid(),
                                    ACTVAL = _ConfidentIPCData.GetACTVAL.ToString(),
                                    INSUSER = user,
                                    INSDTTM = curDttm,
                                    EFCTTIMEIN = curDttm,
                                    EFCTTIMEOUT = curDttm,
                ...
                return new AsyncCommandBase(async arg =>
                {
                    using (await AwaitableLocks["ConfirmCommandAsync"].EnterAsync())
                    {
                        try
                        {
                            ...
                            dt.Columns.Add(new DataColumn("기밀도"));
                            dt.Columns.Add(new DataColumn("외관상태"));
                            dt.Columns.Add(new DataColumn("인장표기사용기한"));
                            dt.Columns.Add(new DataColumn("인장표기제조번호"));
                            dt.Columns.Add(new DataColumn("표시사항및포장단위"));
                            dt.Columns.Add(new DataColumn("확인시험"));
                            ...
                            foreach (var item in _IPCResults)
                            {
                                ...
                                row["기밀도"] = item.RSLT2 ?? "";
                                row["외관상태"] = item.RSLT3 ?? "";
                                row["인장표기사용기한"] = item.RSLT4 ?? "";
                                row["인장표기제조번호"] = item.RSLT5 ?? "";
                                row["표시사항및포장단위"] = item.RSLT6 ?? "";
                                row["확인시험"] = item.RSLT7 ?? "";
                                dt.Rows.Add(row);
                            }
            ...
            try
            {
                ...
                if(await _BR_BRS_SEL_ProductionOrderIPCResult.Execute() && _BR_BRS_SEL_ProductionOrderIPCResult.OUTDATAs.Count > 0 )
                {
                    _IPCResults.Add(new BR_BRS_SEL_ProductionOrderIPCResult.OUTDATA
                    {
                        ...
                        RSLT2 = _AppearanceIPCData.Standard,
                        RSLT3 = _UnitIPCData.Standard,
                        RSLT4 = _BatchIPCData.Standard,
                        RSLT5 = _ExpiryIPCData.Standard,
                        RSLT6 = _ConfirmIPCData.Standard,
                        RSLT7 = _ConfidentIPCData.Standard
                    });
