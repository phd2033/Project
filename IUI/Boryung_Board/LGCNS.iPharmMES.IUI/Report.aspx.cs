...
public partial class Report : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            string rptSvrUserName = "administrator"; 
            string rptSvrPassword = "#cloud01";
            string rptSvrServiceAddress = "http://10.62.207.121/ReportServer_DEV_DBMS";
            ...
            string deviceInfo =
                    ...
                    "<PrintDpiX>150</PrintDpiX>" +
                    "<PrintDpiY>150</PrintDpiY>" +
